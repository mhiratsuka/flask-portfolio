...
def new_post():
    ...
    if form.validate_on_submit():
        ...
        post = Post(worktitle=form.worktitle.data, category=form.category.data, content=form.content.data, author=current_user, workpicture=workpicture, workpicture_name=form.workpicture_name.data)
        db.session.add(post)
        db.session.commit()
